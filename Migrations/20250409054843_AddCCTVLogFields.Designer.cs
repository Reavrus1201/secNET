...
namespace secNET.Migrations
{
    ...
    [Migration("20250409054843_AddCCTVLogFields")]
    partial class AddCCTVLogFields
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("secNET.Models.CCTVLog", b =>
                {
                    ...
                    b.Property<string>("SecuritySupervisor")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("SecuritySupervisorNotes")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("secNET.Models.ChatMessage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("secNET.Models.ChatMessage", b =>
                {
                    ...
                    b.HasOne("secNET.Models.User", "Sender")
                        .WithMany()
